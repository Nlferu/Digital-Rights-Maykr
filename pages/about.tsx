export default function About() {
    return (
        <section className="mt-[6rem] text-center text-white">
            ...
            <div className="inline-block w-[45rem] mt-[1rem]">
                <p>
                    <strong className="list-inside mt-[1rem] text-blue-400 text-xl">Creator And Artists Tool </strong>
