    ...
    return (
        <section className="w-full mt-[6rem] mb-[2rem] lg:mb-[5rem] text-center text-purple-200" ref={ref}>
            <div className="text-center">
                <h1 className="bg-gradient-to-r from-pink-600 via-purple-600 to-red-600 inline-block h-[10rem] text-transparent bg-clip-text text-5xl sm:text-6xl font-bold drop-shadow-shady">
