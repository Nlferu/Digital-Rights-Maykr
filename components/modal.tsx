        ...
        <div ref={modalRef} className="flex flex-col fixed items-center justify-center left-0 top-0 w-full h-full bg-black/60 z-10 px-2" onClick={handleClick}>
            <Tilt tiltReverse={true} glareEnable={true} glareColor="#a4a4a4" glareMaxOpacity={0.35} flipHorizontally={flipHorizontally}>
                {flipHorizontally ? (
                    <div
                        ref={flipRef}
                        className="hover:cursor-pointer gap-[15vw] sm:gap-20 font-bold text-2xl max-w-[500px] max-h-[565.109px] px-[4.791rem] py-[6.1rem] bg-stone-950 border
                                 border-black flex flex-col items-center justify-center my-rotate-y-180 shadow-cert"
                        onClick={handleClick}
                    >
